//
// Created by peteflo on 3/1/16.
//

#ifndef SPLINES_QUADRATICPROGRAMELIMINATIONSOLVE_H
#define SPLINES_QUADRATICPROGRAMELIMINATIONSOLVE_H
...
#endif //SPLINES_QUADRATICPROGRAMELIMINATIONSOLVE_H
